    ...
    function fetchProfile(req, res) {
        res.send({
            ...
            projects : [
                ...
                {title : "Payment System CONAGUA",  technologies : ["C#","MVC3","SQL Server 2008","NHibernate","JQuery","Javascript"], description : "Portal to allow to the customers pay the water usage declaration"},
                {title : "Daycare System ISSSTE",  technologies : ["Java","Java Server Faces","Spring/Spring Security","Hibernate","Informix","Javascript","JQuery"], description : "Portal to take assistance for the kids."},
                ...
                {title : "Ultimate Scrum Poker",  technologies : ["Node JS","Angular JS","Express","Gulp","Socket.IO","Javascript"], description : "Scrum poker game"},
                ...
                {title : "Maze Engine",  technologies : ["Node JS","Vanilla Javascript","Express","Gulp"], description : "Puzzle game to learn to programm in javascript"},
