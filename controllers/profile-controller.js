module.exports = function () {
  ...
  function fetchProfile(req, res) {
    res.send({
      ...
      summary:
        "I'm fullstack developer enthusiastic of technology with experience in designing and developing innovative solutions using .NET, Node JS and Javascript mainly using React JS.",
      talks: [
        {
      ...
      experiences: [
        ...
        },
        {
          ...
          description:
            "I'm doing a migration with a private tool to improve an ETL process for account payment checks.",
        },
        {
        ...
        },
        {
          ...
          company: "Geniutec (Software development company that operates as an entirely virtual organization to create development tools.)",
      ...
      projects: [
        {
          ...
          description:
            "Annexus designs products for retirement process https://www.annexus.com/financial-solutions/",
        },
        {
        ...
        },
        {
          ...
          technologies: ["Node JS", "React Native", "React JS", "Jest", "Enzime"],
          description:
            "IOS Application for issue resolution and sample tracking through mobile.",
          link:
        ...
        },
        {
          ...
          link: "https://github.com/Pabloitto/Surviving-elements",
        },
        {
      ...
      skills: [
        ...
        { name: "Angular 2+(3 years)", level: 80 },
